...
export const aviso: Record<Lang, Aviso> = {
  es: {
    ...
    // Quitar la marca de borrador cuando el área legal apruebe el texto.
    borradorTag: "Borrador",
    borradorTexto: "En revisión por el área legal de la firma.",
  ...
  en: {
    ...
    borradorTag: "Draft",
    borradorTexto: "Under review by the firm's legal team.",
